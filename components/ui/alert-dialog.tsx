    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Viewport className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <AlertDialogPrimitive.Popup
          ...
          className={cn(
            'flex w-full max-w-md flex-col gap-4 rounded-lg bg-popover bg-clip-padding p-6 text-sm text-popover-foreground shadow-lg ring-1 ring-foreground/10 transition duration-150 outline-none data-ending-style:scale-95 data-ending-style:opacity-0 data-starting-style:scale-95 data-starting-style:opacity-0',
            className
          )}
          {...props}
        />
